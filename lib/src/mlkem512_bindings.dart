...
@ffi.DefaultAsset('package:mlkem_native/src/mlkem512_bindings.dart')
library;
...
>()
external int mlkem512_keypair_derand(
...
>()
external int mlkem512_enc_derand(
...
external int mlkem512_check_pk(ffi.Pointer<ffi.Uint8> pk);
...
@ffi.Native<ffi.Int Function(ffi.Pointer<ffi.Uint8>)>()
external int mlkem512_check_sk(ffi.Pointer<ffi.Uint8> sk);

const int MLKEM512_SECRETKEYBYTES = 1632;

const int MLKEM512_PUBLICKEYBYTES = 800;

const int MLKEM512_CIPHERTEXTBYTES = 768;

const int MLKEM512_SYMBYTES = 32;

const int MLKEM512_BYTES = 32;
