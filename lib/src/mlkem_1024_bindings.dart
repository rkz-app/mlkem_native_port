...
@ffi.DefaultAsset('package:mlkem_native/src/mlkem1024_bindings.dart')
library;
...
>()
external int mlkem1024_keypair_derand(
...
external int mlkem1024_keypair(
  ffi.Pointer<ffi.Uint8> pk,
  ffi.Pointer<ffi.Uint8> sk,
);
...
>()
external int mlkem1024_enc_derand(
...
external int mlkem1024_check_pk(ffi.Pointer<ffi.Uint8> pk);
...
@ffi.Native<ffi.Int Function(ffi.Pointer<ffi.Uint8>)>()
external int mlkem1024_check_sk(ffi.Pointer<ffi.Uint8> sk);

const int MLKEM1024_SECRETKEYBYTES = 3168;

const int MLKEM1024_PUBLICKEYBYTES = 1568;

const int MLKEM1024_CIPHERTEXTBYTES = 1568;

const int MLKEM1024_SYMBYTES = 32;

const int MLKEM1024_BYTES = 32;
